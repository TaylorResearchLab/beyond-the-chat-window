...
2. two named AI sessions with assigned roles;
...
Start with a low-risk, bounded, public, or synthetic task. Do not make the first test depend on private clinical data, unreleased collaborator material, or a high-impact production run. Validate the workflow and each integration before expanding the scope.
...
- What scientific question or work unit is in scope?
- Which records, files, and data may each AI session access?
...
The receiving participant must compare the handoff with the current-state page, Collaboration Log, and repository. If they disagree, preserve the uncertainty and repair the record rather than inventing continuity.
