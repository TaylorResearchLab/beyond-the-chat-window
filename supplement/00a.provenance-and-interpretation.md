...
The retrospective study could not recover the exact model identity or exposure state for every historical action because those variables were not recorded prospectively. A new implementation should avoid reproducing that limitation.
